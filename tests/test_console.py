...
"""
    ...
    def test_help_EOF(self):
        ...
        s = 'Exits the program cleanly (^D / CTRL + D).\n        \n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_create(self):
        ...
        s = 'Creates a new instance of BaseModel, saves it (to the\n\
...
\n\
    ...
    def test_help_show(self):
        ...
        s = 'Prints the string representation of an instance based on\n\
...
\n\
    ...
    def test_help_all(self):
        ...
        s = 'Prints all string representation of all instances based\n\
...
\n\
    ...
    def help_test_update(self, classname, uid, attr, val, quotes, func):
        ...
        # print("MSG::", msg)
        # print("CMD::", cmd)
        self.assertEqual(len(msg), len(msg))
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd('{}.show("{}")'.format(classname, uid))
        s = f.getvalue()
