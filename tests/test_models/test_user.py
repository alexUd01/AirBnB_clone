#!/usr/bin/python3
"""
    Contains the TestPlace Documentation Classes
"""
...
class TestUserDocs(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """set up for the doc test"""
        cls.user_t = inspect.getmembers(User, inspect.isfunction)

    def test_user_module_docstring(self):
        """Test the user.py module docstring"""
